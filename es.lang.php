...
return [
    ...
    "modsettings" => "Selecciona las modulos que quieres aparecer en tu pagina principal",
    "m_mostview"  => "Mas Visto",
    "m_inbox"     => "Bandeja De Entrada",
    "m_stats"     => "Estadisticas Del Canal",
    "subsettings" => "Configuraciones de suscripcion",
    "s_num"       => "Number of Rows",
    "s_from"      => "Mostrar Videos De Todos",
    "s_everyone"  => "Todos",
    "in"          => "en",
    "all_cats"    => "Todas Las Categorias",
    "v_newest"    => "Nuevo",
    "v_most_view" => "Mas Visto",
    "v_most_disc" => "Mas Comentados",
    "v_top_rate"  => "Mejor Calificados",
